...
if (file.exists(landuse_cache_file)) {
  ...
  cat("Extracting land use via RASTER method (faster)...\n\n")
  
  library(terra)
  
  # Step 1: Rasterize land use
  cat("Step 1: Converting land use to raster (one-time, ~2-3 min)...\n")
  ...
  cat("  Extracting raster values (this takes 5-10 min)...\n")
